...
public interface InterbankInterface {
	 ...
	 *  @throws UnrecognizedException - if responded with an unknown error code or something goes wrong
	 */
	public abstract PaymentTransaction payOrder(Card card, int amount, String contents) 
			throws PaymentException,UnrecognizedException;
	/**
	 * Refund then return payment transaction
	 * @param card - the credit card which would be refuned to
